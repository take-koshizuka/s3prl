...
class Model(nn.Module):
    def __init__(self,
        ...
        self.speaker_embedding = nn.Embedding(len(TGTSPKS), spk_emb_dim)
    ...
    def forward(self, features, lens, ref_spk_labels, targets = None):
        """Calculate forward propagation.
            Args:
            ...
            ref_spk_labels: Batch of the sequences of reference speaker labels (B, 1).
        """
        B = features.shape[0]
        ...
        ref_spk_embs = self.speaker_embedding(ref_spk_labels)
        ...
        if self.ar:
            ...
            for t, encoder_state in enumerate(encoder_states.transpose(0, 1)):
                ...
                prev_out = self.normalize(prev_out, ref_spk_labels) # apply normalization
